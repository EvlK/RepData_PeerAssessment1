...
```{r total_steps_per_day_mean_median,echo=TRUE,results='hold'}
...
```{r avg_daily_activity_pattern_maxSteps, echo=TRUE,results='asis'}
...
```{r imputing_missing_values,echo=TRUE,results='asis'}
newData<-aData
...
```{r imputing_missing_values_mean_median,echo=TRUE,results='asis'}
